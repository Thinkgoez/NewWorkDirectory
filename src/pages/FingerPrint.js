...
const FingerPrint = () => {
    ...
    return (
        <StyledView alignItems='center'>
            ...
            <StyledButton onPress={open} marginVertical='50px' paddingVertical='20px' borderRadius='10px' border='1px solid #c9c9c9' width='100px' alignItems='center'><StyledText>Try again</StyledText></StyledButton>
